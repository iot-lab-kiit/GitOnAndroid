...
import com.manichord.mgit.activities.CommitDiffActivity;
...
import com.manichord.mgit.dialogs.CheckoutDialog;
...
public class CommitsFragment extends BaseFragment implements
    ...
    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        ...
        if (itemId == R.id.action_mode_diff) {
            ...
            return true;
        } else if (itemId == R.id.action_mode_copy_commit) {
            ...
            actionMode.finish();
            return true;
        } else if (itemId == R.id.action_mode_checkout) {
            int item = mChosenItem.iterator().next();
            String commit = mCommitsListAdapter.getItem(item).getName();

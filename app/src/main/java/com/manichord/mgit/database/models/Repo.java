package com.manichord.mgit.database.models;
...
import com.manichord.mgit.tasks.repo.RepoOpTask;
...
public class Repo implements Comparable<Repo>, Serializable {
    ...
    public void updateLatestCommitInfo() {
        ...
        if (commit != null) {
            ...
            msg = commit.getShortMessage() != null ? commit.getShortMessage()
                    : msg;
            long date = Objects.requireNonNull(committer).getWhen().getTime();
    ...
    public static void setLocalRepoRoot(Context context, File repoRoot) {
        ...
        File oldRoot = Objects.requireNonNull(prefs).getRepoRoot();
